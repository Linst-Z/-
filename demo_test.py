...
epochs = 2200           # 训练次数
batch_num = 35         # train_set训练里集参与训练的问答对个数
...
def get_samples(train_set, batch_num):  #构造样本数据:传入的train_set是处理好的问答集
    raw_encoder_input = []
    raw_decoder_input = []
...
def get_model(feed_previous=False):   #构造模型
